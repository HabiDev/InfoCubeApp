...
ActiveRecord::Schema[7.0].define(version: 2026_03_03_150712) do
  ...
  create_table "frovs", force: :cascade do |t|
    t.integer "store_id", default: 0, null: false
    t.string "provider"
    t.string "product_group"
    t.integer "product_id"
    t.string "product"
    t.integer "day_store"
    t.decimal "sales_two_week", precision: 10, scale: 2, default: "0.0"
  ...
  create_table "order_coolings", force: :cascade do |t|
    t.integer "store_id", default: 0, null: false
    t.string "store"
    t.string "provider"
    t.string "product_group"
